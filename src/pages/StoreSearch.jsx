...
import * as Search from '../pageComponents/StoreSearch/StoreSearch';
      ...
      <Search.StoreSearchBox>
        ...
        <Search.StoreListBox>
          <Search.ListTitle>
            ...
            {store.map((item) => (
              <Search.StoreBox key={item.id}>
                <Search.TitleLink href={item?.place_url}>
                  <Search.PlaceName>{item?.place_name}</Search.PlaceName>
                </Search.TitleLink>
                <Search.PlaceAddress>{item?.road_address_name}</Search.PlaceAddress>
                <Search.PlaceAddress>{item?.phone}</Search.PlaceAddress>
              </Search.StoreBox>
            ))}
          </Search.ListTitle>
        </Search.StoreListBox>
